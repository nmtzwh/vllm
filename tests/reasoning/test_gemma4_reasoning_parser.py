...
def generic_tokenizer():
    ...
    enc_map = {
        "This is a reasoning section": [101],
        "This is the rest": [102],
        "This\nThat": [103],
        "This is the rest\nThat": [104],
        "This is reasoning": [105],
        "This is content": [106],
        "Before\n": [107],
        "\nThis is the rest": [108],
        "": [],
    }
    dec_map = {
        10: "<|channel>",
        11: "<channel|>",
        101: "This is a reasoning section",
        102: "This is the rest",
        103: "This\nThat",
        104: "This is the rest\nThat",
        105: "This is reasoning",
        106: "This is content",
        107: "Before\n",
        108: "\nThis is the rest",
    }
    ...
    tokenizer.decode.side_effect = lambda token_ids: dec_map.get(token_ids[0], "")

    def _encode(text: str, add_special_tokens: bool = False):
        return enc_map.get(text, [200 + len(text)])

    def _tokenize(text: str):
        tokens = []
        i = 0
        while i < len(text):
            if text.startswith("<|channel>", i):
                tokens.append("<|channel>")
                i += len("<|channel>")
            elif text.startswith("<channel|>", i):
                tokens.append("<channel|>")
                i += len("<channel|>")
            else:
                next_positions = [
    ...
    tokenizer.tokenize.side_effect = _tokenize
